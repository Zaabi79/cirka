...
class AddressFieldForm3 extends StatelessWidget {
  ...
  Map<String, dynamic> getConvertFields(Map<String, dynamic> fields, Map<String, dynamic> additionFields) {
  ...
  Widget build(BuildContext context) {
    ...
    Map<String, dynamic> fields = getConvertFields(getFields(nickname), additionFields);
